...
export default function Hand() {
  ...
  return (
    <div
      className={`absolute flex top-3 left-1/2 transform -translate-x-1/2 w-1/2 h-32 m-2 p-2 rounded-lg overflow-x-auto items-center justify-center bg-gradient-to-r from-neutral-700 via-neutral-600 to-neutral-700 transition-all duration-200 ${
