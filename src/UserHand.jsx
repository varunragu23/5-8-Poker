...
export default function UserHand() {
    ...
    return (
        <div
            className={`absolute bottom-3 left-1/2 transform -translate-x-1/2 w-1/2 h-32 justify-center m-2 p-2 rounded-lg flex items-center space-x-[-20px] bg-gradient-to-r from-neutral-700 via-neutral-600 to-neutral-700 transition-all duration-200 
